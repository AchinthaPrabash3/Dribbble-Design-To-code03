...
function ContactSection() {
  return (
    <motion.section
      ...
      id="contact"
    >
      <div className="p-9 bg-sky-100 rounded-3xl flex gap-10">
        <div className=" p-8 rounded-2xl bg-white">
          <p className="px-3 py-2 rounded-full bg-sky-100 text-blue-500 mb-5 w-fit">
            contacts
          </p>
          <div className="flex items-center gap-4 mb-5">
            <h1 className="text-7xl first-letter:uppercase">get in touch</h1>
            <img src={Logo} className="size-10" />
          </div>
          <p className="mb-10 font-light text-xl">
            We're here to help you embark on your next adventure! <br />
            if you have questions about our trips or are ready to book, <br />
